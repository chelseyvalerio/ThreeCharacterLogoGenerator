...
using the logo generator you will be able to enter up to 3 characters, select text color, select shape of circle, triangle, or square, and finally select shape color. It will then generate an SVG file with your desired logo
